...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "language": "c++",
        "name": "modemc.lagrangians",
        "sources": [
            "modemc/lagrangians.pyx"
        ]
    },
    "module_name": "modemc.lagrangians"
}
END: Cython Metadata */
...
#define __PYX_HAVE__modemc__lagrangians
#define __PYX_HAVE_API__modemc__lagrangians
/* Early includes */
#include <string.h>
#include <stdio.h>
...
#define __Pyx_MODULE_NAME "modemc.lagrangians"
extern int __pyx_module_is_main_modemc__lagrangians;
int __pyx_module_is_main_modemc__lagrangians = 0;

/* Implementation of 'modemc.lagrangians' */
...
static void __pyx_f_6modemc_11lagrangians__compute_OM_lagrangian(struct __pyx_obj_6modemc_6system_System *__pyx_v_system, __Pyx_memviewslice __pyx_v_ts, __Pyx_memviewslice __pyx_v_path, __Pyx_memviewslice __pyx_v_d_path, __Pyx_memviewslice __pyx_v_force, __Pyx_memviewslice __pyx_v_div_force, __Pyx_memviewslice __pyx_v_lagrangian) {
  int __pyx_v_dim;
  int __pyx_v_Nt;
  int __pyx_v_i;
  int __pyx_v_j;
  CYTHON_UNUSED __pyx_t_6modemc_4defs_DTYPE_t __pyx_v_Tf;
  __pyx_t_6modemc_4defs_DTYPE_t __pyx_v_gamma;
  __pyx_t_6modemc_4defs_DTYPE_t __pyx_v_beta;
  __pyx_t_6modemc_4defs_DTYPE_t __pyx_v_rgamma;
  __pyx_t_6modemc_4defs_DTYPE_t __pyx_v__FW_pref;
  __pyx_t_6modemc_4defs_DTYPE_t __pyx_v__divf_pref;
  __pyx_t_6modemc_4defs_DTYPE_t __pyx_v_dx_minus_f;
  ...
  __Pyx_RefNannySetupContext("_compute_OM_lagrangian", 0);

  /* "modemc/lagrangians.pyx":9
 * 
 * cdef void _compute_OM_lagrangian(System system, DTYPE_t[:] ts, DTYPE_t[:,:] path, DTYPE_t[:,:] d_path, DTYPE_t[:,:] force, DTYPE_t[:] div_force, DTYPE_t[:] lagrangian):
 *     cdef int dim = path.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int Nt = path.shape[1]
 *     cdef int i,j
 */
  __pyx_v_dim = (__pyx_v_path.shape[0]);

  /* "modemc/lagrangians.pyx":10
 * cdef void _compute_OM_lagrangian(System system, DTYPE_t[:] ts, DTYPE_t[:,:] path, DTYPE_t[:,:] d_path, DTYPE_t[:,:] force, DTYPE_t[:] div_force, DTYPE_t[:] lagrangian):
 *     cdef int dim = path.shape[0]
 *     cdef int Nt = path.shape[1]             # <<<<<<<<<<<<<<
 *     cdef int i,j
 ...
 */
  __pyx_v_Nt = (__pyx_v_path.shape[1]);

  /* "modemc/lagrangians.pyx":12
 *     cdef int Nt = path.shape[1]
 *     cdef int i,j
 *     cdef DTYPE_t Tf = system.Tf             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_1 = __pyx_v_system->Tf;
  __pyx_v_Tf = __pyx_t_1;

  /* "modemc/lagrangians.pyx":13
 *     cdef int i,j
 *     cdef DTYPE_t Tf = system.Tf
 *     cdef DTYPE_t gamma = system.gamma             # <<<<<<<<<<<<<<
 *     cdef DTYPE_t beta = system.beta
 ...
 */
  __pyx_t_1 = __pyx_v_system->gamma;
  __pyx_v_gamma = __pyx_t_1;

  /* "modemc/lagrangians.pyx":14
 *     cdef DTYPE_t Tf = system.Tf
 *     cdef DTYPE_t gamma = system.gamma
 *     cdef DTYPE_t beta = system.beta             # <<<<<<<<<<<<<<
 *     cdef DTYPE_t rgamma = 1.0/gamma
 ...
 */
  __pyx_t_1 = __pyx_v_system->beta;
  __pyx_v_beta = __pyx_t_1;

  /* "modemc/lagrangians.pyx":15
 *     cdef DTYPE_t gamma = system.gamma
 *     cdef DTYPE_t beta = system.beta
 *     cdef DTYPE_t rgamma = 1.0/gamma             # <<<<<<<<<<<<<<
 *     cdef DTYPE_t _FW_pref = 0.25*(gamma*beta)
 ...
 */
  __pyx_v_rgamma = (((__pyx_t_6modemc_4defs_DTYPE_t)1.0) / __pyx_v_gamma);

  /* "modemc/lagrangians.pyx":16
 *     cdef DTYPE_t beta = system.beta
 *     cdef DTYPE_t rgamma = 1.0/gamma
 *     cdef DTYPE_t _FW_pref = 0.25*(gamma*beta)             # <<<<<<<<<<<<<<
 *     cdef DTYPE_t _divf_pref = 0.5*rgamma
 ...
 */
  __pyx_v__FW_pref = (0.25 * (__pyx_v_gamma * __pyx_v_beta));

  /* "modemc/lagrangians.pyx":17
 *     cdef DTYPE_t rgamma = 1.0/gamma
 *     cdef DTYPE_t _FW_pref = 0.25*(gamma*beta)
 *     cdef DTYPE_t _divf_pref = 0.5*rgamma             # <<<<<<<<<<<<<<
 *     cdef DTYPE_t dx_minus_f
 * 
 */
  __pyx_v__divf_pref = (0.5 * __pyx_v_rgamma);

  /* "modemc/lagrangians.pyx":20
 *     cdef DTYPE_t dx_minus_f
 * 
 ...
 *     #for i in range(Nt):
 */
  (void)(((struct __pyx_vtabstruct_6modemc_6system_System *)__pyx_v_system->__pyx_vtab)->_compute_force_and_div_force(__pyx_v_system, __pyx_v_ts, __pyx_v_path, __pyx_v_force, __pyx_v_div_force));

  /* "modemc/lagrangians.pyx":28
 ...
 */
    __pyx_t_5 = __pyx_v_i;
    __pyx_t_6 = __pyx_v_i;
    *((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=0 */ (__pyx_v_lagrangian.data + __pyx_t_6 * __pyx_v_lagrangian.strides[0]) )) = (__pyx_v__divf_pref * (*((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=0 */ (__pyx_v_div_force.data + __pyx_t_5 * __pyx_v_div_force.strides[0]) ))));
  }

  /* "modemc/lagrangians.pyx":31
 *         lagrangian[i] = _divf_pref * div_force[i]
 * 
 *     for j in range(dim):             # <<<<<<<<<<<<<<
 *         for i in range(Nt):
 ...
 */
      ...
      __pyx_v_dx_minus_f = ((*((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_d_path.data + __pyx_t_5 * __pyx_v_d_path.strides[0]) ) + __pyx_t_6 * __pyx_v_d_path.strides[1]) ))) - (__pyx_v_rgamma * (*((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_force.data + __pyx_t_10 * __pyx_v_force.strides[0]) ) + __pyx_t_11 * __pyx_v_force.strides[1]) )))));

      /* "modemc/lagrangians.pyx":34
 *         for i in range(Nt):
 *             dx_minus_f = d_path[j,i] - rgamma*force[j,i]
 *             lagrangian[i] += _FW_pref*dx_minus_f*dx_minus_f             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_11 = __pyx_v_i;
      *((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=0 */ (__pyx_v_lagrangian.data + __pyx_t_11 * __pyx_v_lagrangian.strides[0]) )) += ((__pyx_v__FW_pref * __pyx_v_dx_minus_f) * __pyx_v_dx_minus_f);
    }
  }
...
static void __pyx_f_6modemc_11lagrangians__compute_relative_OM_lagrangian(struct __pyx_obj_6modemc_6system_System *__pyx_v_system, __Pyx_memviewslice __pyx_v_ts, __Pyx_memviewslice __pyx_v_path, __Pyx_memviewslice __pyx_v_d_path, __Pyx_memviewslice __pyx_v_force, __Pyx_memviewslice __pyx_v_div_force, __Pyx_memviewslice __pyx_v_lagrangian) {
  int __pyx_v_dim;
  int __pyx_v_Nt;
  int __pyx_v_i;
  int __pyx_v_j;
  ...
  __pyx_t_6modemc_4defs_DTYPE_t __pyx_v_beta;
  __pyx_t_6modemc_4defs_DTYPE_t __pyx_v_rgamma;
  __pyx_t_6modemc_4defs_DTYPE_t __pyx_v__ff_pref;
  __pyx_t_6modemc_4defs_DTYPE_t __pyx_v__fdx_pref;
  __pyx_t_6modemc_4defs_DTYPE_t __pyx_v__divf_pref;
  __Pyx_RefNannyDeclarations
  __pyx_t_6modemc_4defs_DTYPE_t __pyx_t_1;
  int __pyx_t_2;
  ...
  __Pyx_RefNannySetupContext("_compute_relative_OM_lagrangian", 0);

  /* "modemc/lagrangians.pyx":37
 * 
 * cdef void _compute_relative_OM_lagrangian(System system, DTYPE_t[:] ts, DTYPE_t[:,:] path, DTYPE_t[:,:] d_path, DTYPE_t[:,:] force, DTYPE_t[:] div_force, DTYPE_t[:] lagrangian):
 *     cdef int dim = path.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int Nt = path.shape[1]
 ...
 *     cdef DTYPE_t _divf_pref = 0.5*rgamma
 */
  __pyx_v__ff_pref = ((0.25 * __pyx_v_beta) * __pyx_v_rgamma);

  /* "modemc/lagrangians.pyx":45
 *     cdef DTYPE_t rgamma = 1.0/gamma
 *     cdef DTYPE_t _ff_pref = 0.25*beta*rgamma
 *     cdef DTYPE_t _fdx_pref = 0.5*beta             # <<<<<<<<<<<<<<
 *     cdef DTYPE_t _divf_pref = 0.5*rgamma
 * 
 */
  __pyx_v__fdx_pref = (0.5 * __pyx_v_beta);

  /* "modemc/lagrangians.pyx":46
 *     cdef DTYPE_t _ff_pref = 0.25*beta*rgamma
 *     cdef DTYPE_t _fdx_pref = 0.5*beta
 *     cdef DTYPE_t _divf_pref = 0.5*rgamma             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      *((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=0 */ (__pyx_v_lagrangian.data + __pyx_t_14 * __pyx_v_lagrangian.strides[0]) )) += ((*((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_force.data + __pyx_t_5 * __pyx_v_force.strides[0]) ) + __pyx_t_6 * __pyx_v_force.strides[1]) ))) * ((__pyx_v__ff_pref * (*((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_force.data + __pyx_t_10 * __pyx_v_force.strides[0]) ) + __pyx_t_11 * __pyx_v_force.strides[1]) )))) - (__pyx_v__fdx_pref * (*((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_d_path.data + __pyx_t_12 * __pyx_v_d_path.strides[0]) ) + __pyx_t_13 * __pyx_v_d_path.strides[1]) ))))));
    }
  }
...
static void __pyx_f_6modemc_11lagrangians__compute_FW_lagrangian(struct __pyx_obj_6modemc_6system_System *__pyx_v_system, __Pyx_memviewslice __pyx_v_ts, __Pyx_memviewslice __pyx_v_path, __Pyx_memviewslice __pyx_v_d_path, __Pyx_memviewslice __pyx_v_force, CYTHON_UNUSED __Pyx_memviewslice __pyx_v_div_force, __Pyx_memviewslice __pyx_v_lagrangian) {
  int __pyx_v_dim;
  int __pyx_v_Nt;
  int __pyx_v_i;
  int __pyx_v_j;
  ...
  Py_ssize_t __pyx_t_10;
  Py_ssize_t __pyx_t_11;
  __Pyx_RefNannySetupContext("_compute_FW_lagrangian", 0);

  /* "modemc/lagrangians.pyx":63
 * 
 * cdef void _compute_FW_lagrangian(System system, DTYPE_t[:] ts, DTYPE_t[:,:] path, DTYPE_t[:,:] d_path, DTYPE_t[:,:] force, DTYPE_t[:] div_force, DTYPE_t[:] lagrangian):
 *     cdef int dim = path.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int Nt = path.shape[1]
 ...
 *     #for i in range(Nt):
 */
  (void)(((struct __pyx_vtabstruct_6modemc_6system_System *)__pyx_v_system->__pyx_vtab)->_compute_force(__pyx_v_system, __pyx_v_ts, __pyx_v_path, __pyx_v_force));

  /* "modemc/lagrangians.pyx":81
 *     #        lagrangian[i] += _FW_pref*dx_minus_f*dx_minus_f
 * 
 *     for i in range(Nt):             # <<<<<<<<<<<<<<
 *         lagrangian[i] = 0
 ...
 */
    __pyx_t_5 = __pyx_v_i;
    *((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=0 */ (__pyx_v_lagrangian.data + __pyx_t_5 * __pyx_v_lagrangian.strides[0]) )) = 0.0;
  }

  /* "modemc/lagrangians.pyx":84
 *         lagrangian[i] = 0
 * 
 *     for j in range(dim):             # <<<<<<<<<<<<<<
 *         for i in range(Nt):
 ...
 */
      ...
      __pyx_t_10 = __pyx_v_j;
      __pyx_t_11 = __pyx_v_i;
      __pyx_v_dx_minus_f = ((*((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_d_path.data + __pyx_t_5 * __pyx_v_d_path.strides[0]) ) + __pyx_t_9 * __pyx_v_d_path.strides[1]) ))) - (__pyx_v_rgamma * (*((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_force.data + __pyx_t_10 * __pyx_v_force.strides[0]) ) + __pyx_t_11 * __pyx_v_force.strides[1]) )))));

      /* "modemc/lagrangians.pyx":87
 *         for i in range(Nt):
 *             dx_minus_f = d_path[j,i] - rgamma*force[j,i]
 *             lagrangian[i] += _FW_pref*dx_minus_f*dx_minus_f             # <<<<<<<<<<<<<<
 * 
...
static void __pyx_f_6modemc_11lagrangians__compute_relative_FW_lagrangian(struct __pyx_obj_6modemc_6system_System *__pyx_v_system, __Pyx_memviewslice __pyx_v_ts, __Pyx_memviewslice __pyx_v_path, __Pyx_memviewslice __pyx_v_d_path, __Pyx_memviewslice __pyx_v_force, CYTHON_UNUSED __Pyx_memviewslice __pyx_v_div_force, __Pyx_memviewslice __pyx_v_lagrangian) {
  int __pyx_v_dim;
  int __pyx_v_Nt;
  int __pyx_v_i;
  int __pyx_v_j;
  ...
  Py_ssize_t __pyx_t_13;
  Py_ssize_t __pyx_t_14;
  __Pyx_RefNannySetupContext("_compute_relative_FW_lagrangian", 0);

  /* "modemc/lagrangians.pyx":90
 * 
 * cdef void _compute_relative_FW_lagrangian(System system, DTYPE_t[:] ts, DTYPE_t[:,:] path, DTYPE_t[:,:] d_path, DTYPE_t[:,:] force, DTYPE_t[:] div_force, DTYPE_t[:] lagrangian):
 *     cdef int dim = path.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int Nt = path.shape[1]
 ...
 */
      ...
      __pyx_t_13 = __pyx_v_i;
      __pyx_t_14 = __pyx_v_i;
      *((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=0 */ (__pyx_v_lagrangian.data + __pyx_t_14 * __pyx_v_lagrangian.strides[0]) )) += ((*((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_force.data + __pyx_t_5 * __pyx_v_force.strides[0]) ) + __pyx_t_9 * __pyx_v_force.strides[1]) ))) * ((__pyx_v__ff_pref * (*((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_force.data + __pyx_t_10 * __pyx_v_force.strides[0]) ) + __pyx_t_11 * __pyx_v_force.strides[1]) )))) - (__pyx_v__fdx_pref * (*((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_d_path.data + __pyx_t_12 * __pyx_v_d_path.strides[0]) ) + __pyx_t_13 * __pyx_v_d_path.strides[1]) ))))));
    }
  }
...
static void __pyx_f_6modemc_11lagrangians__compute_OM_discretised_lagrangian(struct __pyx_obj_6modemc_6system_System *__pyx_v_system, __Pyx_memviewslice __pyx_v_ts, __Pyx_memviewslice __pyx_v_path, __Pyx_memviewslice __pyx_v_force, __Pyx_memviewslice __pyx_v_div_force, __Pyx_memviewslice __pyx_v_lagrangian) {
  int __pyx_v_dim;
  int __pyx_v_Nt;
  int __pyx_v_i;
  int __pyx_v_j;
  ...
  __pyx_t_6modemc_4defs_DTYPE_t __pyx_v_beta;
  __pyx_t_6modemc_4defs_DTYPE_t __pyx_v_rgamma;
  __pyx_t_6modemc_4defs_DTYPE_t __pyx_v_dt;
  __pyx_t_6modemc_4defs_DTYPE_t __pyx_v__FW_pref;
  __pyx_t_6modemc_4defs_DTYPE_t __pyx_v__divf_pref;
  __pyx_t_6modemc_4defs_DTYPE_t __pyx_v_dx_minus_f;
  __pyx_t_6modemc_4defs_DTYPE_t __pyx_v_rdt;
  __Pyx_RefNannyDeclarations
  __pyx_t_6modemc_4defs_DTYPE_t __pyx_t_1;
  ...
  Py_ssize_t __pyx_t_12;
  Py_ssize_t __pyx_t_13;
  __Pyx_RefNannySetupContext("_compute_OM_discretised_lagrangian", 0);

  /* "modemc/lagrangians.pyx":117
 * 
 * cdef void _compute_OM_discretised_lagrangian(System system, DTYPE_t[:] ts, DTYPE_t[:,:] path, DTYPE_t[:,:] force, DTYPE_t[:] div_force, DTYPE_t[:] lagrangian):
 *     cdef int dim = path.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int Nt = path.shape[1]
 ...
 */
  __pyx_t_2 = 1;
  __pyx_t_3 = 0;
  __pyx_v_dt = ((*((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=0 */ (__pyx_v_ts.data + __pyx_t_2 * __pyx_v_ts.strides[0]) ))) - (*((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=0 */ (__pyx_v_ts.data + __pyx_t_3 * __pyx_v_ts.strides[0]) ))));

  /* "modemc/lagrangians.pyx":125
 *     cdef DTYPE_t rgamma = 1.0/gamma
 *     cdef DTYPE_t dt = ts[1] - ts[0]
 *     cdef DTYPE_t _FW_pref = dt*0.25*(gamma*beta)             # <<<<<<<<<<<<<<
 *     cdef DTYPE_t _divf_pref = dt*0.5*rgamma
 *     cdef DTYPE_t dx_minus_f
 */
  __pyx_v__FW_pref = ((__pyx_v_dt * 0.25) * (__pyx_v_gamma * __pyx_v_beta));

  /* "modemc/lagrangians.pyx":126
 *     cdef DTYPE_t dt = ts[1] - ts[0]
 *     cdef DTYPE_t _FW_pref = dt*0.25*(gamma*beta)
 *     cdef DTYPE_t _divf_pref = dt*0.5*rgamma             # <<<<<<<<<<<<<<
 *     cdef DTYPE_t dx_minus_f
 ...
 */
  __pyx_v__divf_pref = ((__pyx_v_dt * 0.5) * __pyx_v_rgamma);

  /* "modemc/lagrangians.pyx":128
 *     cdef DTYPE_t _divf_pref = dt*0.5*rgamma
 *     cdef DTYPE_t dx_minus_f
 *     cdef DTYPE_t rdt = 1.0/dt             # <<<<<<<<<<<<<<
 * 
 *     system._compute_force_and_div_force(ts, path, force, div_force)
 */
  __pyx_v_rdt = (((__pyx_t_6modemc_4defs_DTYPE_t)1.0) / __pyx_v_dt);

  /* "modemc/lagrangians.pyx":130
 *     cdef DTYPE_t rdt = 1.0/dt
 * 
 *     system._compute_force_and_div_force(ts, path, force, div_force)             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
  __pyx_t_4 = (__pyx_v_Nt - 1);
  __pyx_t_5 = __pyx_t_4;
  for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
    __pyx_v_i = __pyx_t_6;

    /* "modemc/lagrangians.pyx":139
 * 
 *     for i in range(Nt-1):
 *         lagrangian[i] = _divf_pref * div_force[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_3 = __pyx_v_i;
    __pyx_t_2 = __pyx_v_i;
    *((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=0 */ (__pyx_v_lagrangian.data + __pyx_t_2 * __pyx_v_lagrangian.strides[0]) )) = (__pyx_v__divf_pref * (*((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=0 */ (__pyx_v_div_force.data + __pyx_t_3 * __pyx_v_div_force.strides[0]) ))));
  }

  /* "modemc/lagrangians.pyx":141
 *         lagrangian[i] = _divf_pref * div_force[i]
 * 
 *     for j in range(dim):             # <<<<<<<<<<<<<<
 *         for i in range(Nt-1):
 ...
 */
      ...
      __pyx_t_12 = __pyx_v_j;
      __pyx_t_13 = __pyx_v_i;
      __pyx_v_dx_minus_f = ((((*((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_path.data + __pyx_t_3 * __pyx_v_path.strides[0]) ) + __pyx_t_2 * __pyx_v_path.strides[1]) ))) - (*((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_path.data + __pyx_t_10 * __pyx_v_path.strides[0]) ) + __pyx_t_11 * __pyx_v_path.strides[1]) )))) * __pyx_v_rdt) - (__pyx_v_rgamma * (*((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_force.data + __pyx_t_12 * __pyx_v_force.strides[0]) ) + __pyx_t_13 * __pyx_v_force.strides[1]) )))));

      /* "modemc/lagrangians.pyx":144
 *         for i in range(Nt-1):
 *             dx_minus_f = (path[j,i+1]-path[j,i])*rdt - rgamma*force[j,i]
 *             lagrangian[i] += _FW_pref*dx_minus_f*dx_minus_f             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_13 = __pyx_v_i;
      *((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=0 */ (__pyx_v_lagrangian.data + __pyx_t_13 * __pyx_v_lagrangian.strides[0]) )) += ((__pyx_v__FW_pref * __pyx_v_dx_minus_f) * __pyx_v_dx_minus_f);
    }
  }
...
static void __pyx_f_6modemc_11lagrangians__compute_relative_OM_discretised_lagrangian(struct __pyx_obj_6modemc_6system_System *__pyx_v_system, __Pyx_memviewslice __pyx_v_ts, __Pyx_memviewslice __pyx_v_path, __Pyx_memviewslice __pyx_v_force, __Pyx_memviewslice __pyx_v_div_force, __Pyx_memviewslice __pyx_v_lagrangian) {
  int __pyx_v_dim;
  int __pyx_v_Nt;
  int __pyx_v_i;
  int __pyx_v_j;
  ...
  __Pyx_RefNannySetupContext("_compute_relative_OM_discretised_lagrangian", 0);

  /* "modemc/lagrangians.pyx":147
 * 
 * cdef void _compute_relative_OM_discretised_lagrangian(System system, DTYPE_t[:] ts, DTYPE_t[:,:] path, DTYPE_t[:,:] force, DTYPE_t[:] div_force, DTYPE_t[:] lagrangian):
 *     cdef int dim = path.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int Nt = path.shape[1]
 ...
 */
  __pyx_v__ff_pref = (((__pyx_v_dt * 0.25) * __pyx_v_beta) * __pyx_v_rgamma);

  /* "modemc/lagrangians.pyx":157
 *     cdef DTYPE_t _ff_pref = dt*0.25*beta*rgamma
 *     #cdef DTYPE_t _ff_pref = 0.5*dt*0.25*beta*rgamma
 *     cdef DTYPE_t _fdx_pref = dt*0.5*beta             # <<<<<<<<<<<<<<
 *     cdef DTYPE_t _divf_pref = dt*0.5*rgamma
 *     cdef DTYPE_t rdt = 1.0/dt
 */
  __pyx_v__fdx_pref = ((__pyx_v_dt * 0.5) * __pyx_v_beta);

  /* "modemc/lagrangians.pyx":158
 *     #cdef DTYPE_t _ff_pref = 0.5*dt*0.25*beta*rgamma
 *     cdef DTYPE_t _fdx_pref = dt*0.5*beta
 *     cdef DTYPE_t _divf_pref = dt*0.5*rgamma             # <<<<<<<<<<<<<<
 *     cdef DTYPE_t rdt = 1.0/dt
 ...
 */
      ...
      *((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=0 */ (__pyx_v_lagrangian.data + __pyx_t_16 * __pyx_v_lagrangian.strides[0]) )) += ((*((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_force.data + __pyx_t_3 * __pyx_v_force.strides[0]) ) + __pyx_t_2 * __pyx_v_force.strides[1]) ))) * ((__pyx_v__ff_pref * (*((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_force.data + __pyx_t_10 * __pyx_v_force.strides[0]) ) + __pyx_t_11 * __pyx_v_force.strides[1]) )))) - ((__pyx_v__fdx_pref * ((*((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_path.data + __pyx_t_12 * __pyx_v_path.strides[0]) ) + __pyx_t_13 * __pyx_v_path.strides[1]) ))) - (*((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_path.data + __pyx_t_14 * __pyx_v_path.strides[0]) ) + __pyx_t_15 * __pyx_v_path.strides[1]) ))))) * __pyx_v_rdt)));
    }
  }
...
static void __pyx_f_6modemc_11lagrangians__compute_FW_discretised_lagrangian(struct __pyx_obj_6modemc_6system_System *__pyx_v_system, __Pyx_memviewslice __pyx_v_ts, __Pyx_memviewslice __pyx_v_path, __Pyx_memviewslice __pyx_v_force, CYTHON_UNUSED __Pyx_memviewslice __pyx_v_div_force, __Pyx_memviewslice __pyx_v_lagrangian) {
  int __pyx_v_dim;
  int __pyx_v_Nt;
  int __pyx_v_i;
  int __pyx_v_j;
  ...
  Py_ssize_t __pyx_t_12;
  Py_ssize_t __pyx_t_13;
  __Pyx_RefNannySetupContext("_compute_FW_discretised_lagrangian", 0);

  /* "modemc/lagrangians.pyx":177
 * 
 * cdef void _compute_FW_discretised_lagrangian(System system, DTYPE_t[:] ts, DTYPE_t[:,:] path, DTYPE_t[:,:] force, DTYPE_t[:] div_force, DTYPE_t[:] lagrangian):
 *     cdef int dim = path.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int Nt = path.shape[1]
 ...
 */
    __pyx_t_3 = __pyx_v_i;
    *((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=0 */ (__pyx_v_lagrangian.data + __pyx_t_3 * __pyx_v_lagrangian.strides[0]) )) = 0.0;
  }

  /* "modemc/lagrangians.pyx":194
 *         lagrangian[i] = 0
 * 
 *     for j in range(dim):             # <<<<<<<<<<<<<<
 *         for i in range(Nt-1):
...
static void __pyx_f_6modemc_11lagrangians__compute_relative_FW_discretised_lagrangian(struct __pyx_obj_6modemc_6system_System *__pyx_v_system, __Pyx_memviewslice __pyx_v_ts, __Pyx_memviewslice __pyx_v_path, __Pyx_memviewslice __pyx_v_force, CYTHON_UNUSED __Pyx_memviewslice __pyx_v_div_force, __Pyx_memviewslice __pyx_v_lagrangian) {
  int __pyx_v_dim;
  int __pyx_v_Nt;
  int __pyx_v_i;
  int __pyx_v_j;
  ...
  Py_ssize_t __pyx_t_15;
  Py_ssize_t __pyx_t_16;
  __Pyx_RefNannySetupContext("_compute_relative_FW_discretised_lagrangian", 0);

  /* "modemc/lagrangians.pyx":200
 * 
 * cdef void _compute_relative_FW_discretised_lagrangian(System system, DTYPE_t[:] ts, DTYPE_t[:,:] path, DTYPE_t[:,:] force, DTYPE_t[:] div_force, DTYPE_t[:] lagrangian):
 *     cdef int dim = path.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int Nt = path.shape[1]
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "modemc.lagrangians.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "modemc.lagrangians.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "modemc.lagrangians.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "modemc.lagrangians._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_lagrangians(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_lagrangians},
  {0, NULL}
};
#endif
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("_compute_OM_lagrangian", (void (*)(void))__pyx_f_6modemc_11lagrangians__compute_OM_lagrangian, "void (struct __pyx_obj_6modemc_6system_System *, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_compute_relative_OM_lagrangian", (void (*)(void))__pyx_f_6modemc_11lagrangians__compute_relative_OM_lagrangian, "void (struct __pyx_obj_6modemc_6system_System *, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_compute_FW_lagrangian", (void (*)(void))__pyx_f_6modemc_11lagrangians__compute_FW_lagrangian, "void (struct __pyx_obj_6modemc_6system_System *, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_compute_relative_FW_lagrangian", (void (*)(void))__pyx_f_6modemc_11lagrangians__compute_relative_FW_lagrangian, "void (struct __pyx_obj_6modemc_6system_System *, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_compute_OM_discretised_lagrangian", (void (*)(void))__pyx_f_6modemc_11lagrangians__compute_OM_discretised_lagrangian, "void (struct __pyx_obj_6modemc_6system_System *, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_compute_relative_OM_discretised_lagrangian", (void (*)(void))__pyx_f_6modemc_11lagrangians__compute_relative_OM_discretised_lagrangian, "void (struct __pyx_obj_6modemc_6system_System *, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_compute_FW_discretised_lagrangian", (void (*)(void))__pyx_f_6modemc_11lagrangians__compute_FW_discretised_lagrangian, "void (struct __pyx_obj_6modemc_6system_System *, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_compute_relative_FW_discretised_lagrangian", (void (*)(void))__pyx_f_6modemc_11lagrangians__compute_relative_FW_discretised_lagrangian, "void (struct __pyx_obj_6modemc_6system_System *, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initlagrangians(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initlagrangians(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_lagrangians(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_lagrangians(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_lagrangians(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'lagrangians' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_lagrangians(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("lagrangians", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_modemc__lagrangians) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "modemc.lagrangians")) {
      if (unlikely(PyDict_SetItemString(modules, "modemc.lagrangians", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init modemc.lagrangians", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init modemc.lagrangians");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
