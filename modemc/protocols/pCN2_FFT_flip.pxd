...
cdef class pCN2_FFT_Flip(PathMCMC):
    cdef public:
        np.ndarray kappas
        np.ndarray skappas
        np.ndarray pkappas
        ...
        np.ndarray window_state

        np.ndarray window_path_buffer
        np.ndarray window_d_path_buffer
        np.ndarray window_prev_path_buffer
        np.ndarray window_prev_d_path_buffer

        np.ndarray window_interpolation_schemes
        np.ndarray window_phis
        np.ndarray window_dphis
