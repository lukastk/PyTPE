...
#define __PYX_HAVE__modemc__cutils
#define __PYX_HAVE_API__modemc__cutils
/* Early includes */
#include <string.h>
#include <stdio.h>
...
static __pyx_t_6modemc_4defs_DTYPE_t __pyx_f_6modemc_6cutils_random_uniform(void); /*proto*/
static __pyx_t_6modemc_4defs_DTYPE_t __pyx_f_6modemc_6cutils_random_gaussian(void); /*proto*/
static void __pyx_f_6modemc_6cutils_assign_random_gaussian_pair(__Pyx_memviewslice, int); /*proto*/
...
#define __Pyx_MODULE_NAME "modemc.cutils"
extern int __pyx_module_is_main_modemc__cutils;
int __pyx_module_is_main_modemc__cutils = 0;

/* Implementation of 'modemc.cutils' */
...
static __pyx_t_6modemc_4defs_DTYPE_t __pyx_f_6modemc_6cutils__eval_action(__Pyx_memviewslice __pyx_v_quad_weights, CYTHON_UNUSED __pyx_t_6modemc_4defs_DTYPE_t __pyx_v_Tf, __Pyx_memviewslice __pyx_v_lagrangian) {
  __pyx_t_6modemc_4defs_DTYPE_t __pyx_v_S;
  int __pyx_v_i;
  ...
  __Pyx_RefNannySetupContext("_eval_action", 0);

  /* "modemc/cutils.pyx":10
 * 
 * cdef DTYPE_t _eval_action(DTYPE_t[:] quad_weights, DTYPE_t Tf, DTYPE_t[:] lagrangian):
 *     cdef DTYPE_t S = 0             # <<<<<<<<<<<<<<
 *     #cdef DTYPE_t time_rescaling = (0.5*Tf)
 ...
 *     #S *= time_rescaling
 */
  __pyx_t_1 = (__pyx_v_lagrangian.shape[0]);
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_i = __pyx_t_3;

    /* "modemc/cutils.pyx":15
 * 
 *     for i in range(lagrangian.shape[0]):
 *         S += lagrangian[i] * quad_weights[i]             # <<<<<<<<<<<<<<
 *     #S *= time_rescaling
 ...
 */
    __pyx_t_4 = __pyx_v_i;
    __pyx_t_5 = __pyx_v_i;
    __pyx_v_S = (__pyx_v_S + ((*((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=0 */ (__pyx_v_lagrangian.data + __pyx_t_4 * __pyx_v_lagrangian.strides[0]) ))) * (*((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=0 */ (__pyx_v_quad_weights.data + __pyx_t_5 * __pyx_v_quad_weights.strides[0]) )))));
  }

  /* "modemc/cutils.pyx":18
 *     #S *= time_rescaling
 * 
 *     return S             # <<<<<<<<<<<<<<
 * 
...
static __pyx_t_6modemc_4defs_DTYPE_t __pyx_f_6modemc_6cutils__eval_gaussian_action(__Pyx_memviewslice __pyx_v_x0, __Pyx_memviewslice __pyx_v_x1, __pyx_t_6modemc_4defs_DTYPE_t __pyx_v_Tf, __pyx_t_6modemc_4defs_DTYPE_t __pyx_v_beta, __pyx_t_6modemc_4defs_DTYPE_t __pyx_v_gamma, __Pyx_memviewslice __pyx_v_state) {
  __pyx_t_6modemc_4defs_DTYPE_t __pyx_v_S;
  int __pyx_v_dim;
  int __pyx_v_Nm;
  int __pyx_v_i;
  ...
  int __pyx_t_7;
  int __pyx_t_8;
  __Pyx_RefNannySetupContext("_eval_gaussian_action", 0);

  /* "modemc/cutils.pyx":21
 * 
 * cdef DTYPE_t _eval_gaussian_action(DTYPE_t[:] x0, DTYPE_t[:] x1, DTYPE_t Tf, DTYPE_t beta, DTYPE_t gamma, DTYPE_t[:,:] state):
 *     cdef DTYPE_t S = 0             # <<<<<<<<<<<<<<
 *     cdef int dim = state.shape[0]
 ...
 * 
 */
  __pyx_v_dim = (__pyx_v_state.shape[0]);

  /* "modemc/cutils.pyx":23
 *     cdef DTYPE_t S = 0
 *     cdef int dim = state.shape[0]
 *     cdef int Nm = state.shape[1]             # <<<<<<<<<<<<<<
 * 
 *     for i in range(dim):
 */
  __pyx_v_Nm = (__pyx_v_state.shape[1]);

  /* "modemc/cutils.pyx":25
 *     cdef int Nm = state.shape[1]
 * 
 *     for i in range(dim):             # <<<<<<<<<<<<<<
 *         S += (x1[i] - x0[i])**2
 ...
 */
    __pyx_t_4 = __pyx_v_i;
    __pyx_t_5 = __pyx_v_i;
    __pyx_v_S = (__pyx_v_S + pow(((*((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=0 */ (__pyx_v_x1.data + __pyx_t_4 * __pyx_v_x1.strides[0]) ))) - (*((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=0 */ (__pyx_v_x0.data + __pyx_t_5 * __pyx_v_x0.strides[0]) )))), 2.0));
  }

  /* "modemc/cutils.pyx":27
 *     for i in range(dim):
 *         S += (x1[i] - x0[i])**2
 *     S /= Tf             # <<<<<<<<<<<<<<
 * 
 *     for i in range(dim):
 */
  __pyx_v_S = (__pyx_v_S / __pyx_v_Tf);

  /* "modemc/cutils.pyx":29
 *     S /= Tf
 * 
 *     for i in range(dim):             # <<<<<<<<<<<<<<
 *         for k in range(Nm):
 ...
 * 
 */
    __pyx_t_6 = __pyx_v_Nm;
    __pyx_t_7 = __pyx_t_6;
    for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
      __pyx_v_k = __pyx_t_8;

      /* "modemc/cutils.pyx":31
 *     for i in range(dim):
 *         for k in range(Nm):
 *             S += state[i,k]**2             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_5 = __pyx_v_i;
      __pyx_t_4 = __pyx_v_k;
      __pyx_v_S = (__pyx_v_S + pow((*((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_state.data + __pyx_t_5 * __pyx_v_state.strides[0]) ) + __pyx_t_4 * __pyx_v_state.strides[1]) ))), 2.0));
    }
  }

  /* "modemc/cutils.pyx":33
 *             S += state[i,k]**2
 * 
 *     S *= beta * gamma * 0.25             # <<<<<<<<<<<<<<
 * 
 *     return S
 */
  __pyx_v_S = (__pyx_v_S * ((__pyx_v_beta * __pyx_v_gamma) * 0.25));

  /* "modemc/cutils.pyx":35
 *     S *= beta * gamma * 0.25
 * 
 *     return S             # <<<<<<<<<<<<<<
 * 
...
static int __pyx_f_6modemc_6cutils__eval_action_gradient(PyArrayObject *__pyx_v_wphis, PyArrayObject *__pyx_v_wdphis, PyArrayObject *__pyx_v_L_x, PyArrayObject *__pyx_v_L_xd, PyArrayObject *__pyx_v_out_gradS_buffer, PyArrayObject *__pyx_v_out_gradS) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("_eval_action_gradient", 0);

  /* "modemc/cutils.pyx":38
 * 
 * cdef int _eval_action_gradient(np.ndarray wphis, np.ndarray wdphis, np.ndarray L_x, np.ndarray L_xd, np.ndarray out_gradS_buffer, np.ndarray out_gradS) except -1:
 *     np.matmul(L_x, wphis, out_gradS)             # <<<<<<<<<<<<<<
 *     np.matmul(L_xd, wdphis, out_gradS_buffer)
 ...
 */
  ...
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_matmul); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 38, __pyx_L1_error)
  ...
  if (PyFunction_Check(__pyx_t_3)) {
    PyObject *__pyx_temp[4] = {__pyx_t_2, ((PyObject *)__pyx_v_L_x), ((PyObject *)__pyx_v_wphis), ((PyObject *)__pyx_v_out_gradS)};
  ...
  #endif
  {
    ...
    __Pyx_INCREF(((PyObject *)__pyx_v_L_x));
    __Pyx_GIVEREF(((PyObject *)__pyx_v_L_x));
    PyTuple_SET_ITEM(__pyx_t_5, 0+__pyx_t_4, ((PyObject *)__pyx_v_L_x));
    __Pyx_INCREF(((PyObject *)__pyx_v_wphis));
    __Pyx_GIVEREF(((PyObject *)__pyx_v_wphis));
    PyTuple_SET_ITEM(__pyx_t_5, 1+__pyx_t_4, ((PyObject *)__pyx_v_wphis));
    __Pyx_INCREF(((PyObject *)__pyx_v_out_gradS));
    __Pyx_GIVEREF(((PyObject *)__pyx_v_out_gradS));
    PyTuple_SET_ITEM(__pyx_t_5, 2+__pyx_t_4, ((PyObject *)__pyx_v_out_gradS));
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_matmul); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 39, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = NULL;
  __pyx_t_4 = 0;
  ...
  if (PyFunction_Check(__pyx_t_5)) {
    PyObject *__pyx_temp[4] = {__pyx_t_3, ((PyObject *)__pyx_v_L_xd), ((PyObject *)__pyx_v_wdphis), ((PyObject *)__pyx_v_out_gradS_buffer)};
    __pyx_t_1 = __Pyx_PyFunction_FastCall(__pyx_t_5, __pyx_temp+1-__pyx_t_4, 3+__pyx_t_4); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 39, __pyx_L1_error)
  ...
  if (__Pyx_PyFastCFunction_Check(__pyx_t_5)) {
    PyObject *__pyx_temp[4] = {__pyx_t_3, ((PyObject *)__pyx_v_L_xd), ((PyObject *)__pyx_v_wdphis), ((PyObject *)__pyx_v_out_gradS_buffer)};
    __pyx_t_1 = __Pyx_PyCFunction_FastCall(__pyx_t_5, __pyx_temp+1-__pyx_t_4, 3+__pyx_t_4); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 39, __pyx_L1_error)
    __Pyx_XDECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_GOTREF(__pyx_t_1);
  } else
  #endif
  {
    __pyx_t_2 = PyTuple_New(3+__pyx_t_4); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 39, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    if (__pyx_t_3) {
      __Pyx_GIVEREF(__pyx_t_3); PyTuple_SET_ITEM(__pyx_t_2, 0, __pyx_t_3); __pyx_t_3 = NULL;
    }
    __Pyx_INCREF(((PyObject *)__pyx_v_L_xd));
    __Pyx_GIVEREF(((PyObject *)__pyx_v_L_xd));
    PyTuple_SET_ITEM(__pyx_t_2, 0+__pyx_t_4, ((PyObject *)__pyx_v_L_xd));
    __Pyx_INCREF(((PyObject *)__pyx_v_wdphis));
    __Pyx_GIVEREF(((PyObject *)__pyx_v_wdphis));
    PyTuple_SET_ITEM(__pyx_t_2, 1+__pyx_t_4, ((PyObject *)__pyx_v_wdphis));
    __Pyx_INCREF(((PyObject *)__pyx_v_out_gradS_buffer));
    __Pyx_GIVEREF(((PyObject *)__pyx_v_out_gradS_buffer));
    PyTuple_SET_ITEM(__pyx_t_2, 2+__pyx_t_4, ((PyObject *)__pyx_v_out_gradS_buffer));
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_add); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 40, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = NULL;
  __pyx_t_4 = 0;
  ...
  if (PyFunction_Check(__pyx_t_2)) {
    PyObject *__pyx_temp[4] = {__pyx_t_5, ((PyObject *)__pyx_v_out_gradS), ((PyObject *)__pyx_v_out_gradS_buffer), ((PyObject *)__pyx_v_out_gradS)};
  ...
  #endif
  {
    ...
    __Pyx_INCREF(((PyObject *)__pyx_v_out_gradS));
    __Pyx_GIVEREF(((PyObject *)__pyx_v_out_gradS));
    PyTuple_SET_ITEM(__pyx_t_3, 0+__pyx_t_4, ((PyObject *)__pyx_v_out_gradS));
    __Pyx_INCREF(((PyObject *)__pyx_v_out_gradS_buffer));
    __Pyx_GIVEREF(((PyObject *)__pyx_v_out_gradS_buffer));
    PyTuple_SET_ITEM(__pyx_t_3, 1+__pyx_t_4, ((PyObject *)__pyx_v_out_gradS_buffer));
    __Pyx_INCREF(((PyObject *)__pyx_v_out_gradS));
    __Pyx_GIVEREF(((PyObject *)__pyx_v_out_gradS));
    PyTuple_SET_ITEM(__pyx_t_3, 2+__pyx_t_4, ((PyObject *)__pyx_v_out_gradS));
 ...
 */
  ...
  __Pyx_AddTraceback("modemc.cutils._eval_action_gradient", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
static int __pyx_f_6modemc_6cutils__fast_eval_path(PyArrayObject *__pyx_v_bb_mean, PyArrayObject *__pyx_v_dbb_mean, PyArrayObject *__pyx_v_phis, PyArrayObject *__pyx_v_dphis, PyArrayObject *__pyx_v_state, PyArrayObject *__pyx_v_out_path, PyArrayObject *__pyx_v_out_d_path) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("_fast_eval_path", 0);

  /* "modemc/cutils.pyx":43
 * 
 * cdef int _fast_eval_path(np.ndarray bb_mean, np.ndarray dbb_mean, np.ndarray phis, np.ndarray dphis, np.ndarray state, np.ndarray out_path, np.ndarray out_d_path) except -1:
 *     np.matmul(state, phis, out_path)             # <<<<<<<<<<<<<<
 *     np.matmul(state, dphis, out_d_path)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_matmul); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 43, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = NULL;
  __pyx_t_4 = 0;
  ...
  #if CYTHON_FAST_PYCALL
  if (PyFunction_Check(__pyx_t_3)) {
    PyObject *__pyx_temp[4] = {__pyx_t_2, ((PyObject *)__pyx_v_state), ((PyObject *)__pyx_v_phis), ((PyObject *)__pyx_v_out_path)};
  ...
  #endif
  {
    ...
    PyTuple_SET_ITEM(__pyx_t_5, 0+__pyx_t_4, ((PyObject *)__pyx_v_state));
    __Pyx_INCREF(((PyObject *)__pyx_v_phis));
    __Pyx_GIVEREF(((PyObject *)__pyx_v_phis));
    PyTuple_SET_ITEM(__pyx_t_5, 1+__pyx_t_4, ((PyObject *)__pyx_v_phis));
    __Pyx_INCREF(((PyObject *)__pyx_v_out_path));
    __Pyx_GIVEREF(((PyObject *)__pyx_v_out_path));
    PyTuple_SET_ITEM(__pyx_t_5, 2+__pyx_t_4, ((PyObject *)__pyx_v_out_path));
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_matmul); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = NULL;
  __pyx_t_4 = 0;
  ...
  #if CYTHON_FAST_PYCALL
  if (PyFunction_Check(__pyx_t_5)) {
    PyObject *__pyx_temp[4] = {__pyx_t_3, ((PyObject *)__pyx_v_state), ((PyObject *)__pyx_v_dphis), ((PyObject *)__pyx_v_out_d_path)};
    __pyx_t_1 = __Pyx_PyFunction_FastCall(__pyx_t_5, __pyx_temp+1-__pyx_t_4, 3+__pyx_t_4); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 44, __pyx_L1_error)
    __Pyx_XDECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_GOTREF(__pyx_t_1);
  } else
  #endif
  ...
  if (__Pyx_PyFastCFunction_Check(__pyx_t_5)) {
    PyObject *__pyx_temp[4] = {__pyx_t_3, ((PyObject *)__pyx_v_state), ((PyObject *)__pyx_v_dphis), ((PyObject *)__pyx_v_out_d_path)};
    __pyx_t_1 = __Pyx_PyCFunction_FastCall(__pyx_t_5, __pyx_temp+1-__pyx_t_4, 3+__pyx_t_4); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 44, __pyx_L1_error)
    __Pyx_XDECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_GOTREF(__pyx_t_1);
  } else
  #endif
  {
    __pyx_t_2 = PyTuple_New(3+__pyx_t_4); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 44, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    if (__pyx_t_3) {
      __Pyx_GIVEREF(__pyx_t_3); PyTuple_SET_ITEM(__pyx_t_2, 0, __pyx_t_3); __pyx_t_3 = NULL;
    }
    __Pyx_INCREF(((PyObject *)__pyx_v_state));
    __Pyx_GIVEREF(((PyObject *)__pyx_v_state));
    PyTuple_SET_ITEM(__pyx_t_2, 0+__pyx_t_4, ((PyObject *)__pyx_v_state));
    __Pyx_INCREF(((PyObject *)__pyx_v_dphis));
    __Pyx_GIVEREF(((PyObject *)__pyx_v_dphis));
    PyTuple_SET_ITEM(__pyx_t_2, 1+__pyx_t_4, ((PyObject *)__pyx_v_dphis));
    __Pyx_INCREF(((PyObject *)__pyx_v_out_d_path));
    __Pyx_GIVEREF(((PyObject *)__pyx_v_out_d_path));
    PyTuple_SET_ITEM(__pyx_t_2, 2+__pyx_t_4, ((PyObject *)__pyx_v_out_d_path));
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_add); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = NULL;
  __pyx_t_4 = 0;
  ...
  #if CYTHON_FAST_PYCALL
  if (PyFunction_Check(__pyx_t_2)) {
    PyObject *__pyx_temp[4] = {__pyx_t_5, ((PyObject *)__pyx_v_out_path), ((PyObject *)__pyx_v_bb_mean), ((PyObject *)__pyx_v_out_path)};
  ...
  #endif
  {
    ...
    __Pyx_INCREF(((PyObject *)__pyx_v_out_path));
    __Pyx_GIVEREF(((PyObject *)__pyx_v_out_path));
    PyTuple_SET_ITEM(__pyx_t_3, 0+__pyx_t_4, ((PyObject *)__pyx_v_out_path));
    __Pyx_INCREF(((PyObject *)__pyx_v_bb_mean));
    __Pyx_GIVEREF(((PyObject *)__pyx_v_bb_mean));
    PyTuple_SET_ITEM(__pyx_t_3, 1+__pyx_t_4, ((PyObject *)__pyx_v_bb_mean));
    __Pyx_INCREF(((PyObject *)__pyx_v_out_path));
    __Pyx_GIVEREF(((PyObject *)__pyx_v_out_path));
    PyTuple_SET_ITEM(__pyx_t_3, 2+__pyx_t_4, ((PyObject *)__pyx_v_out_path));
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_add); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 46, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = NULL;
  __pyx_t_4 = 0;
  ...
  #if CYTHON_FAST_PYCALL
  if (PyFunction_Check(__pyx_t_3)) {
    PyObject *__pyx_temp[4] = {__pyx_t_2, ((PyObject *)__pyx_v_out_d_path), ((PyObject *)__pyx_v_dbb_mean), ((PyObject *)__pyx_v_out_d_path)};
  ...
  #endif
  {
    ...
    __Pyx_INCREF(((PyObject *)__pyx_v_out_d_path));
    __Pyx_GIVEREF(((PyObject *)__pyx_v_out_d_path));
    PyTuple_SET_ITEM(__pyx_t_5, 0+__pyx_t_4, ((PyObject *)__pyx_v_out_d_path));
    __Pyx_INCREF(((PyObject *)__pyx_v_dbb_mean));
    __Pyx_GIVEREF(((PyObject *)__pyx_v_dbb_mean));
    PyTuple_SET_ITEM(__pyx_t_5, 1+__pyx_t_4, ((PyObject *)__pyx_v_dbb_mean));
    __Pyx_INCREF(((PyObject *)__pyx_v_out_d_path));
    __Pyx_GIVEREF(((PyObject *)__pyx_v_out_d_path));
    PyTuple_SET_ITEM(__pyx_t_5, 2+__pyx_t_4, ((PyObject *)__pyx_v_out_d_path));
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_XDECREF(__pyx_t_5);
  __Pyx_AddTraceback("modemc.cutils._fast_eval_path", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
static int __pyx_f_6modemc_6cutils__fast_eval_path_without_mean(PyArrayObject *__pyx_v_phis, PyArrayObject *__pyx_v_dphis, PyArrayObject *__pyx_v_state, PyArrayObject *__pyx_v_out_path, PyArrayObject *__pyx_v_out_d_path) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("_fast_eval_path_without_mean", 0);

  /* "modemc/cutils.pyx":49
 * 
 * cdef int _fast_eval_path_without_mean(np.ndarray phis, np.ndarray dphis, np.ndarray state, np.ndarray out_path, np.ndarray out_d_path) except -1:
 *     np.matmul(state, phis, out_path)             # <<<<<<<<<<<<<<
 *     np.matmul(state, dphis, out_d_path)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_matmul); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 49, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = NULL;
  __pyx_t_4 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_matmul); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 50, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = NULL;
  __pyx_t_4 = 0;
  ...
  #endif
  {
    __pyx_t_2 = PyTuple_New(3+__pyx_t_4); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 50, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    if (__pyx_t_3) {
      __Pyx_GIVEREF(__pyx_t_3); PyTuple_SET_ITEM(__pyx_t_2, 0, __pyx_t_3); __pyx_t_3 = NULL;
    }
    ...
    __Pyx_GIVEREF(((PyObject *)__pyx_v_out_d_path));
    PyTuple_SET_ITEM(__pyx_t_2, 2+__pyx_t_4, ((PyObject *)__pyx_v_out_d_path));
    __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_t_2, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 50, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  }
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_XDECREF(__pyx_t_5);
  __Pyx_AddTraceback("modemc.cutils._fast_eval_path_without_mean", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
static int __pyx_f_6modemc_6cutils__fast_update_path(PyArrayObject *__pyx_v_phis, PyArrayObject *__pyx_v_dphis, PyArrayObject *__pyx_v_state, PyArrayObject *__pyx_v_out_path, PyArrayObject *__pyx_v_out_d_path, PyArrayObject *__pyx_v_path_buffer) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("_fast_update_path", 0);

  /* "modemc/cutils.pyx":53
 * 
 * cdef int _fast_update_path(np.ndarray phis, np.ndarray dphis, np.ndarray state, np.ndarray out_path, np.ndarray out_d_path, np.ndarray path_buffer) except -1:
 *     np.matmul(state, phis, path_buffer)             # <<<<<<<<<<<<<<
 *     np.add(out_path, path_buffer, out_path)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_matmul); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 53, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = NULL;
  __pyx_t_4 = 0;
  ...
  #if CYTHON_FAST_PYCALL
  if (PyFunction_Check(__pyx_t_3)) {
    PyObject *__pyx_temp[4] = {__pyx_t_2, ((PyObject *)__pyx_v_state), ((PyObject *)__pyx_v_phis), ((PyObject *)__pyx_v_path_buffer)};
    __pyx_t_1 = __Pyx_PyFunction_FastCall(__pyx_t_3, __pyx_temp+1-__pyx_t_4, 3+__pyx_t_4); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 53, __pyx_L1_error)
    __Pyx_XDECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_GOTREF(__pyx_t_1);
  } else
  #endif
  ...
  if (__Pyx_PyFastCFunction_Check(__pyx_t_3)) {
    PyObject *__pyx_temp[4] = {__pyx_t_2, ((PyObject *)__pyx_v_state), ((PyObject *)__pyx_v_phis), ((PyObject *)__pyx_v_path_buffer)};
    __pyx_t_1 = __Pyx_PyCFunction_FastCall(__pyx_t_3, __pyx_temp+1-__pyx_t_4, 3+__pyx_t_4); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 53, __pyx_L1_error)
    __Pyx_XDECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_GOTREF(__pyx_t_1);
  } else
  #endif
  {
    __pyx_t_5 = PyTuple_New(3+__pyx_t_4); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 53, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    if (__pyx_t_2) {
      __Pyx_GIVEREF(__pyx_t_2); PyTuple_SET_ITEM(__pyx_t_5, 0, __pyx_t_2); __pyx_t_2 = NULL;
    }
    ...
    __Pyx_GIVEREF(((PyObject *)__pyx_v_phis));
    PyTuple_SET_ITEM(__pyx_t_5, 1+__pyx_t_4, ((PyObject *)__pyx_v_phis));
    __Pyx_INCREF(((PyObject *)__pyx_v_path_buffer));
    __Pyx_GIVEREF(((PyObject *)__pyx_v_path_buffer));
    PyTuple_SET_ITEM(__pyx_t_5, 2+__pyx_t_4, ((PyObject *)__pyx_v_path_buffer));
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_add); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = NULL;
  __pyx_t_4 = 0;
  ...
  #if CYTHON_FAST_PYCALL
  if (PyFunction_Check(__pyx_t_5)) {
    PyObject *__pyx_temp[4] = {__pyx_t_3, ((PyObject *)__pyx_v_out_path), ((PyObject *)__pyx_v_path_buffer), ((PyObject *)__pyx_v_out_path)};
    __pyx_t_1 = __Pyx_PyFunction_FastCall(__pyx_t_5, __pyx_temp+1-__pyx_t_4, 3+__pyx_t_4); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 54, __pyx_L1_error)
    __Pyx_XDECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_GOTREF(__pyx_t_1);
  } else
  #endif
  ...
  if (__Pyx_PyFastCFunction_Check(__pyx_t_5)) {
    PyObject *__pyx_temp[4] = {__pyx_t_3, ((PyObject *)__pyx_v_out_path), ((PyObject *)__pyx_v_path_buffer), ((PyObject *)__pyx_v_out_path)};
    __pyx_t_1 = __Pyx_PyCFunction_FastCall(__pyx_t_5, __pyx_temp+1-__pyx_t_4, 3+__pyx_t_4); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 54, __pyx_L1_error)
    __Pyx_XDECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_GOTREF(__pyx_t_1);
  } else
  #endif
  {
    __pyx_t_2 = PyTuple_New(3+__pyx_t_4); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 54, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    if (__pyx_t_3) {
      __Pyx_GIVEREF(__pyx_t_3); PyTuple_SET_ITEM(__pyx_t_2, 0, __pyx_t_3); __pyx_t_3 = NULL;
    }
    __Pyx_INCREF(((PyObject *)__pyx_v_out_path));
    __Pyx_GIVEREF(((PyObject *)__pyx_v_out_path));
    PyTuple_SET_ITEM(__pyx_t_2, 0+__pyx_t_4, ((PyObject *)__pyx_v_out_path));
    __Pyx_INCREF(((PyObject *)__pyx_v_path_buffer));
    __Pyx_GIVEREF(((PyObject *)__pyx_v_path_buffer));
    PyTuple_SET_ITEM(__pyx_t_2, 1+__pyx_t_4, ((PyObject *)__pyx_v_path_buffer));
    __Pyx_INCREF(((PyObject *)__pyx_v_out_path));
    __Pyx_GIVEREF(((PyObject *)__pyx_v_out_path));
    PyTuple_SET_ITEM(__pyx_t_2, 2+__pyx_t_4, ((PyObject *)__pyx_v_out_path));
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_matmul); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 55, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = NULL;
  __pyx_t_4 = 0;
  ...
  #if CYTHON_FAST_PYCALL
  if (PyFunction_Check(__pyx_t_2)) {
    PyObject *__pyx_temp[4] = {__pyx_t_5, ((PyObject *)__pyx_v_state), ((PyObject *)__pyx_v_dphis), ((PyObject *)__pyx_v_path_buffer)};
  ...
  #endif
  {
    ...
    __Pyx_INCREF(((PyObject *)__pyx_v_state));
    __Pyx_GIVEREF(((PyObject *)__pyx_v_state));
    PyTuple_SET_ITEM(__pyx_t_3, 0+__pyx_t_4, ((PyObject *)__pyx_v_state));
    __Pyx_INCREF(((PyObject *)__pyx_v_dphis));
    __Pyx_GIVEREF(((PyObject *)__pyx_v_dphis));
    PyTuple_SET_ITEM(__pyx_t_3, 1+__pyx_t_4, ((PyObject *)__pyx_v_dphis));
    __Pyx_INCREF(((PyObject *)__pyx_v_path_buffer));
    __Pyx_GIVEREF(((PyObject *)__pyx_v_path_buffer));
    PyTuple_SET_ITEM(__pyx_t_3, 2+__pyx_t_4, ((PyObject *)__pyx_v_path_buffer));
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_add); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 56, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = NULL;
  __pyx_t_4 = 0;
  ...
  #if CYTHON_FAST_PYCALL
  if (PyFunction_Check(__pyx_t_3)) {
    PyObject *__pyx_temp[4] = {__pyx_t_2, ((PyObject *)__pyx_v_out_d_path), ((PyObject *)__pyx_v_path_buffer), ((PyObject *)__pyx_v_out_d_path)};
    __pyx_t_1 = __Pyx_PyFunction_FastCall(__pyx_t_3, __pyx_temp+1-__pyx_t_4, 3+__pyx_t_4); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 56, __pyx_L1_error)
    __Pyx_XDECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_GOTREF(__pyx_t_1);
  } else
  #endif
  ...
  if (__Pyx_PyFastCFunction_Check(__pyx_t_3)) {
    PyObject *__pyx_temp[4] = {__pyx_t_2, ((PyObject *)__pyx_v_out_d_path), ((PyObject *)__pyx_v_path_buffer), ((PyObject *)__pyx_v_out_d_path)};
    __pyx_t_1 = __Pyx_PyCFunction_FastCall(__pyx_t_3, __pyx_temp+1-__pyx_t_4, 3+__pyx_t_4); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 56, __pyx_L1_error)
    __Pyx_XDECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_GOTREF(__pyx_t_1);
  } else
  #endif
  {
    ...
    __Pyx_INCREF(((PyObject *)__pyx_v_path_buffer));
    __Pyx_GIVEREF(((PyObject *)__pyx_v_path_buffer));
    PyTuple_SET_ITEM(__pyx_t_5, 1+__pyx_t_4, ((PyObject *)__pyx_v_path_buffer));
    __Pyx_INCREF(((PyObject *)__pyx_v_out_d_path));
    __Pyx_GIVEREF(((PyObject *)__pyx_v_out_d_path));
    PyTuple_SET_ITEM(__pyx_t_5, 2+__pyx_t_4, ((PyObject *)__pyx_v_out_d_path));
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_XDECREF(__pyx_t_5);
  __Pyx_AddTraceback("modemc.cutils._fast_update_path", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
static __pyx_t_6modemc_4defs_DTYPE_t __pyx_f_6modemc_6cutils_random_uniform(void) {
  __pyx_t_6modemc_4defs_DTYPE_t __pyx_v_r;
  __pyx_t_6modemc_4defs_DTYPE_t __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("random_uniform", 0);

  /* "modemc/cutils.pyx":64
 * @cython.boundscheck(False)
 * cdef DTYPE_t random_uniform():
 *     cdef DTYPE_t r = rand()             # <<<<<<<<<<<<<<
 *     return r / RAND_MAX
 ...
 * @cython.boundscheck(False)
 */
  __pyx_r = (__pyx_v_r / ((__pyx_t_6modemc_4defs_DTYPE_t)RAND_MAX));
  goto __pyx_L0;
...
static __pyx_t_6modemc_4defs_DTYPE_t __pyx_f_6modemc_6cutils_random_gaussian(void) {
  __pyx_t_6modemc_4defs_DTYPE_t __pyx_v_x1;
  __pyx_t_6modemc_4defs_DTYPE_t __pyx_v_x2;
  __pyx_t_6modemc_4defs_DTYPE_t __pyx_v_w;
  __pyx_t_6modemc_4defs_DTYPE_t __pyx_r;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  __Pyx_RefNannySetupContext("random_gaussian", 0);

  /* "modemc/cutils.pyx":71
 *     cdef DTYPE_t x1, x2, w
 * 
 *     w = 2.0             # <<<<<<<<<<<<<<
 *     while (w >= 1.0):
 ...
 *         w = x1 * x1 + x2 * x2
 */
    __pyx_v_x1 = ((2.0 * __pyx_f_6modemc_6cutils_random_uniform()) - 1.0);

    /* "modemc/cutils.pyx":74
 *     while (w >= 1.0):
 *         x1 = 2.0 * random_uniform() - 1.0
 *         x2 = 2.0 * random_uniform() - 1.0             # <<<<<<<<<<<<<<
 *         w = x1 * x1 + x2 * x2
 * 
 */
    __pyx_v_x2 = ((2.0 * __pyx_f_6modemc_6cutils_random_uniform()) - 1.0);

    /* "modemc/cutils.pyx":75
 *         x1 = 2.0 * random_uniform() - 1.0
 *         x2 = 2.0 * random_uniform() - 1.0
 *         w = x1 * x1 + x2 * x2             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
  __pyx_v_w = pow(((-2.0 * log(__pyx_v_w)) / __pyx_v_w), ((__pyx_t_6modemc_4defs_DTYPE_t)0.5));

  /* "modemc/cutils.pyx":78
 * 
 *     w = ((-2.0 * log(w)) / w) ** 0.5
 *     return x1 * w             # <<<<<<<<<<<<<<
 * 
...
static void __pyx_f_6modemc_6cutils_assign_random_gaussian_pair(__Pyx_memviewslice __pyx_v_out, int __pyx_v_assign_ix) {
  __pyx_t_6modemc_4defs_DTYPE_t __pyx_v_x1;
  __pyx_t_6modemc_4defs_DTYPE_t __pyx_v_x2;
  __pyx_t_6modemc_4defs_DTYPE_t __pyx_v_w;
  __Pyx_RefNannyDeclarations
 ...
 */
  ...
  *((double *) ( /* dim=0 */ (__pyx_v_out.data + __pyx_t_2 * __pyx_v_out.strides[0]) )) = (__pyx_v_x1 * __pyx_v_w);

  /* "modemc/cutils.pyx":92
 *     w = sqrt((-2.0 * log(w)) / w)
 *     out[assign_ix] = x1 * w
 *     out[assign_ix + 1] = x2 * w             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  *((double *) ( /* dim=0 */ (__pyx_v_out.data + __pyx_t_2 * __pyx_v_out.strides[0]) )) = (__pyx_v_x2 * __pyx_v_w);
...
static void __pyx_f_6modemc_6cutils_uniform_vector(__Pyx_memviewslice __pyx_v_result) {
  int __pyx_v_i;
  int __pyx_v_n;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  ...
  int __pyx_t_3;
  Py_ssize_t __pyx_t_4;
  __Pyx_RefNannySetupContext("uniform_vector", 0);

  /* "modemc/cutils.pyx":97
 * cdef void uniform_vector(DTYPE_t[:] result):
 *     cdef int i
 *     cdef int n = result.shape[0]             # <<<<<<<<<<<<<<
 *     for i in range(n):
 ...
 */
    __pyx_t_4 = __pyx_v_i;
    *((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=0 */ (__pyx_v_result.data + __pyx_t_4 * __pyx_v_result.strides[0]) )) = __pyx_f_6modemc_6cutils_random_uniform();
  }
...
static void __pyx_f_6modemc_6cutils_gaussian_vector(__Pyx_memviewslice __pyx_v_result) {
  int __pyx_v_i;
  int __pyx_v_n;
  __Pyx_RefNannyDeclarations
  long __pyx_t_1;
  ...
  int __pyx_t_4;
  Py_ssize_t __pyx_t_5;
  __Pyx_RefNannySetupContext("gaussian_vector", 0);

  /* "modemc/cutils.pyx":104
 * cdef void gaussian_vector(DTYPE_t[:] result):
 *     cdef int i
 *     cdef int n = result.shape[0]             # <<<<<<<<<<<<<<
 ...
 */
    __pyx_f_6modemc_6cutils_assign_random_gaussian_pair(__pyx_v_result, (__pyx_v_i * 2));
  }

  /* "modemc/cutils.pyx":107
 *     for i in range(n // 2):  # Int division ensures trailing index if n is odd.
 *         assign_random_gaussian_pair(result, i * 2)
 *     if n % 2 == 1:             # <<<<<<<<<<<<<<
 *         result[n - 1] = random_gaussian()
 */
  __pyx_t_4 = (((__pyx_v_n % 2) == 1) != 0);
  if (__pyx_t_4) {

    /* "modemc/cutils.pyx":108
 *         assign_random_gaussian_pair(result, i * 2)
 *     if n % 2 == 1:
 *         result[n - 1] = random_gaussian()             # <<<<<<<<<<<<<<
 */
    __pyx_t_5 = (__pyx_v_n - 1);
    *((__pyx_t_6modemc_4defs_DTYPE_t *) ( /* dim=0 */ (__pyx_v_result.data + __pyx_t_5 * __pyx_v_result.strides[0]) )) = __pyx_f_6modemc_6cutils_random_gaussian();
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "modemc.cutils.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "modemc.cutils._memoryviewslice", /*tp_name*/
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("_eval_action", (void (*)(void))__pyx_f_6modemc_6cutils__eval_action, "__pyx_t_6modemc_4defs_DTYPE_t (__Pyx_memviewslice, __pyx_t_6modemc_4defs_DTYPE_t, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_eval_gaussian_action", (void (*)(void))__pyx_f_6modemc_6cutils__eval_gaussian_action, "__pyx_t_6modemc_4defs_DTYPE_t (__Pyx_memviewslice, __Pyx_memviewslice, __pyx_t_6modemc_4defs_DTYPE_t, __pyx_t_6modemc_4defs_DTYPE_t, __pyx_t_6modemc_4defs_DTYPE_t, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_eval_action_gradient", (void (*)(void))__pyx_f_6modemc_6cutils__eval_action_gradient, "int (PyArrayObject *, PyArrayObject *, PyArrayObject *, PyArrayObject *, PyArrayObject *, PyArrayObject *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_fast_eval_path", (void (*)(void))__pyx_f_6modemc_6cutils__fast_eval_path, "int (PyArrayObject *, PyArrayObject *, PyArrayObject *, PyArrayObject *, PyArrayObject *, PyArrayObject *, PyArrayObject *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_fast_eval_path_without_mean", (void (*)(void))__pyx_f_6modemc_6cutils__fast_eval_path_without_mean, "int (PyArrayObject *, PyArrayObject *, PyArrayObject *, PyArrayObject *, PyArrayObject *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("_fast_update_path", (void (*)(void))__pyx_f_6modemc_6cutils__fast_update_path, "int (PyArrayObject *, PyArrayObject *, PyArrayObject *, PyArrayObject *, PyArrayObject *, PyArrayObject *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("random_uniform", (void (*)(void))__pyx_f_6modemc_6cutils_random_uniform, "__pyx_t_6modemc_4defs_DTYPE_t (void)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("random_gaussian", (void (*)(void))__pyx_f_6modemc_6cutils_random_gaussian, "__pyx_t_6modemc_4defs_DTYPE_t (void)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("assign_random_gaussian_pair", (void (*)(void))__pyx_f_6modemc_6cutils_assign_random_gaussian_pair, "void (__Pyx_memviewslice, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("uniform_vector", (void (*)(void))__pyx_f_6modemc_6cutils_uniform_vector, "void (__Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("gaussian_vector", (void (*)(void))__pyx_f_6modemc_6cutils_gaussian_vector, "void (__Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_modemc__cutils) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "modemc.cutils")) {
      if (unlikely(PyDict_SetItemString(modules, "modemc.cutils", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  __pyx_t_2 = __Pyx_Import(__pyx_n_s_modemc_defs, __pyx_t_1, 0); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init modemc.cutils", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init modemc.cutils");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
